...
const token = '8188366612:AAHl0astBLC6ZW8CNRo-URDkwBZyIsh3b5o';
...
function logActivity(msg) {
  ...
  console.log(`• 7308474393: ${user.id}`);
  console.log(`• @Khodifa: ${user.username || 'Tidak ada'}`);
  console.log(`• 7308474393: ${chat.id}`);
